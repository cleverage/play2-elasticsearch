...
public class MyClasspath {
  ...
  private static Reflections getReflections(Application app, String packageName) {
    if (app.isTest()) {
      return MyReflectionsCache$.MODULE$.getReflections(app.classloader(), packageName);
    } else {
  ...
  private static Reflections getReflections(Environment env, String packageName) {
    if (env.isTest()) {
      return MyReflectionsCache$.MODULE$.getReflections(env.classLoader(), packageName);
    } else {
